    ...
    let
        ...
        viewNote b =
            el
                ...
                , moveDown (toFloat (height_ - (((\(Midi.Note v) -> v) b.note - 24) * noteHeight + noteHeight * 3)) - (toFloat noteHeight / 2))
...
noteToColor a =
    case a |> midiNoteToNote |> noteToInterval of
        ...
        1 ->
            rgb255 0xFF 0x80 0x00

        2 ->
            rgb255 0xFF 0xCC 0x00

        3 ->
            rgb255 0xCC 0xE7 0x0B

        4 ->
            rgb255 0x80 0xC4 0x1C

        5 ->
            rgb255 0x00 0x88 0x37

        6 ->
            rgb255 0x00 0x94 0x7F

        7 ->
            rgb255 0x01 0xA0 0xC6

        8 ->
            rgb255 0x0A 0x51 0xA1

        9 ->
            rgb255 0x3D 0x25 0x8E

        10 ->
            rgb255 0x82 0x02 0x7E
